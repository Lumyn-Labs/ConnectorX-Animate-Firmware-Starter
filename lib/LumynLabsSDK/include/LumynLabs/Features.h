...
// Auto-generated for ConnectorX Animate - DO NOT EDIT
// =============================================================================
...
#define CX_SDK_VARIANT "cx-animate"
#define CX_SDK_VARIANT_NAME "ConnectorX Animate"
...
#define CX_FEATURE_DIO 0
#define CX_FEATURE_AIO 0

// LED Configuration (safe to expose - no pin info)
#define CX_LED_CHANNEL_COUNT 4
...
// Power Configuration
#define CX_REGULATOR_OUTPUT_MA 6000
